            ...
            <div class="prose prose-invert mx-auto max-w-3xl prose-headings:text-white prose-a:text-cyan-400">
                ...
                <section class="mt-10 space-y-4 text-slate-300">
                    ...
                    <p>
                        ...
                        "(Grafana Cloud, US region) receive structured server logs: HTTP method, "
                    ...
                    <p>
                        ...
                        "in the US for reporting. IP addresses are anonymized. Retention: 2 months "
                        "in GA4."
                    </p>
                    ...
                    <p>
                        ...
                        "content) are sent to our server and Grafana Cloud Loki (US). Retention: 30 days."
                    </p>
                </section>
                ...
                <section class="mt-10 space-y-4 text-slate-300">
                    ...
                    <ul class="list-disc space-y-2 pl-6">
                        ...
                        <li>"Grafana Labs / Grafana Cloud (logs and dashboards, US)"</li>
